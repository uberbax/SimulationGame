...
public class Server : MonoBehaviour
{
    ...
    public const int unitsMin = 50;
    public const int unitsMax = 150;
    ...
    public void InitField()
    {
        ...
        for (int i = 0; i < unitsNum; i++)
        {
            ...
            if (!CheckPosition((byte)xR, (byte)yR))
            {
                ...
                player.xPos = (byte)xR;
                player.yPos = (byte)yR;
                player.health = (byte)Random.Range(Server.healthMin, Server.healthMax);
        ...
        for (int i = 0; i < players.Count; i++)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    //additional param to randomize movement
                    int rand = 0;
                    ...
                    if (players[i].xPos > players[opponent].xPos && rand <= 1)
                    {
                        players[i].xPos--;
                    }
                    else if (players[i].xPos < players[opponent].xPos && rand <= 1)
                    {
                        players[i].xPos++;
                    }
                    else
                    {
                        //its equal
                        //checking y
                        if (players[i].yPos > players[opponent].yPos)
                        {
                            players[i].yPos--;
                        }
                        else if (players[i].yPos < players[opponent].yPos)
                        {
                            players[i].yPos++;                           
                        }
                    }
